...
curl "$BASE_REPO_URL/config/cgroup.conf" -o /etc/slurm/cgroup.conf
echo "Fetch $BASE_REPO_URL/config/slurmdbd.conf"
curl "$BASE_REPO_URL/config/slurmdbd.conf" -o /etc/slurm/slurmdbd.conf
echo "Fetch $BASE_REPO_URL/config/$LABEL.slurm.conf"
curl "$BASE_REPO_URL/config/$LABEL.slurm.conf" -o /etc/slurm/slurm.conf
